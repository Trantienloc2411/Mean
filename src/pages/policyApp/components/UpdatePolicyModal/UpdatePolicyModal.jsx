  ...
  useEffect(() => {
    if (initialValues) {
      const startTime = initialValues.StartTime
        ? dayjs(initialValues.StartTime, 'HH:mm DD/MM/YYYY')
        : null;
      const endTime = initialValues.EndTime
        ? dayjs(initialValues.EndTime, 'HH:mm DD/MM/YYYY')
        : null;
    ...
    form
      ...
      .then((values) => {
        const startTime = values.StartTime
          ? values.StartTime.format('HH:mm DD/MM/YYYY')
          : null;
        const endTime = values.EndTime
          ? values.EndTime.format('HH:mm DD/MM/YYYY')
          : null;
            ...
            ({ getFieldValue }) => ({
              validator(_, value) {
                ...
                return Promise.reject(
                  new Error(
                    'Ngày kết thúc phải sau ngày bắt đầu (bao gồm cả giờ phút)'
                  )
                );
              },
            }),

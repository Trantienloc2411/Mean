...
const BookingDetail = ({ bookingId, visible, onClose, bookingData, isLoading, isError }) => {
  ...
  const getPaymentStatusTag = (status) => {
    const paymentStatusMap = {
      ...
      3: { text: "Đã hoàn tiền", color: "blue" },
      4: { text: "Thanh toán thất bại", color: "red" },
    }
              ...
              <Card className={styles.customerCard}>
                ...
                <Descriptions bordered column={1} className={styles.descriptions}>
                  ...
                  {/* <Descriptions.Item label="Ngày tạo tài khoản">
                    {formatDate(getNestedValue(booking, 'customerId.userId.createdAt', null))}
                  </Descriptions.Item> */}
                </Descriptions>
              </Card>
            </Col>
              ...
              <Card className={styles.accommodationCard}>
                ...
                <Descriptions bordered column={1} className={styles.descriptions}>
                  ...
                  <Descriptions.Item label="Trạng thái phòng">
                    {getNestedValue(booking, 'accommodationId.status') === 1 ? (

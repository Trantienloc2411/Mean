                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: "16px", marginBottom: "16px" }}>
                      ...
                      <Form.Item
                        ...
                        style={{ flex: 1, marginBottom: 8 }}
                      >
                        <Input placeholder="Ví dụ: Thời gian, Phụ thu" />
                      </Form.Item>
                    </div>
                    ...
                    <div style={{ display: "flex", gap: "16px" }}>
                      ...
                      >
                        <Select
                          ...
                          filterOption={false}
                          onChange={(value) => handleHashtagChange(value, name)}
                          onBlur={() => {
                            const currentValue = form.getFieldValue(["values", name, "hashTag"]);
